function about(){
    const ab = document.getElementById("menu");
    ab.innerHTML = "Under construction"
    ab.style.lineHeight = "80px"
    ab.style.justifyContent = "center"
    ab.style.height = "330px";
    ab.style.paddingTop = "0px"
}
function projects(){
  const pr = document.getElementById("menu");
    pr.innerHTML = 
        "Clicker: <a href='clicker/index.html'><img src=\"clicker.png\" width=\"200px\" height=\"120px\"></a>"+
        "Portfolio: <a href='portfolio/index.html'><img src=\"portfolio.png\" width=\"200px\" height=\"120px\"></a>";
    pr.style.paddingTop = "100px";
    pr.style.textAlign = "left";
    pr.style.height = "230px";
}
